  ...
  <table className="min-w-full border-collapse border border-black text-left text-gray-200 relative z-[150]">
    ...
    <thead className="bg-[#fff4e6]">
      <tr>
        ...
        <th scope="col" colSpan="2" className="border border-black px-4 py-2 text-gray-600">Qualification
          Standard
        </th>
      </tr>
    </thead>
    ...
    <tbody className="divide-y divide-gray-600">
      <tr>
        <th scope="row" className="border border-black px-4 py-2 font-medium text-gray-100">Nationality</th>
      ...
      <tr>
        ...
        <td className="border border-black px-4 py-2 font-medium text-gray-200">Freshman</td>
        <td className="border border-black px-4 py-2 text-gray-200">Graduation from a high school equivalent
          to the Korean education system's high school
        </td>
      </tr>

      <tr>
        <td className="border border-black px-4 py-2 font-medium text-gray-200">Transfer to 3rd year</td>
      ...
      <tr>
        <td className="border border-black px-4 py-2 font-medium text-gray-200">Transfer to 4th year</td>
        <td className="border border-black px-4 py-2 text-gray-200">
      ...
      <tr>
        ...
        <td className="border border-black px-4 py-2 font-medium text-gray-200">Korean Track</td>
        <td className="border border-black px-4 py-2 text-gray-200">
      ...
      <tr>
        <td className="border border-black px-4 py-2 font-medium text-gray-200">English Track</td>
        <td className="border border-black px-4 py-2 text-gray-200">
