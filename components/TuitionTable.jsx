const TuitionTable = () => (
  <table className="min-w-full border-collapse border border-black text-left text-gray-200 relative z-[150]">
    <caption className="text-lg font-semibold mb-4 text-gray-100">
      Consist of scholarship, selection criteria, scholarship rate (tuition reduction)
    </caption>
    ...
    <tr>
      <th scope="col" className="border border-black px-4 py-2 text-gray-600">
        Scholarship
      </th>
      <th scope="col" className="border border-black px-4 py-2 text-gray-600">
        Selection criteria
    ...
    <tr>
      <th scope="row" className="border border-black px-4 py-2 font-medium text-gray-100">
    ...
    <tr>
      ...
      <td className="border border-black px-4 py-2 text-gray-200">
        Students who are selected as the most superior among the separated joint program class students
      </td>
      <td className="border border-black px-4 py-2 text-gray-200">
        Exempt from tuition
      </td>
    ...
    <tr>
      ...
      <td className="border border-black px-4 py-2 text-gray-200">
        Students who are selected as the superior among the separated joint program class students
      </td>
      <td className="border border-black px-4 py-2 text-gray-200">
        50% reduction
      </td>
    ...
    <tr>
      ...
      <td className="border border-black px-4 py-2 text-gray-200">
        Students who enter to the 2+2 Korean track special program and do not get the International Students
        Scholarship (only in the 1st semester)
      </td>
      <td className="border border-black px-4 py-2 text-gray-200">
        20% reduction
      </td>
